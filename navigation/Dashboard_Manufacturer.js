    ...
    return (
      <ScrollView style={styles.container}>
          ...
          <View style={styles.center}>
            ...
            <TouchableOpacity style={styles.icon} activeOpacity={0.5} onPress={() => this.onClickListener('View_orders_main')}><Text style={styles.baseText}>View Orders</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.center}>
            <TouchableOpacity style={styles.icon} activeOpacity={0.5} onPress={() => this.onClickListener('View_User')}><Text style={styles.baseText}>     My   distributors</Text>
            </TouchableOpacity>
