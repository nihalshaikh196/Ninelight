...
constructor(props)
  ...
  order = () => {
    ...
    const user_type = navigation.getParam('user_type', 'NO-User'); 
  ...
  componentDidMount() {
    ...
    return fetch('http://192.168.43.161/Ninelight/View_Cart.php')
      .then((response) => response.json())
      .then((responseJson) => {
...
FlatListItemSeparator = () => {
    ...
    render() {
        ...
        const { navigation } = this.props;  
    const user_type = navigation.getParam('user_type', 1); 
    ...
    <View style={styles.MainContainer}>
      ...
      keyExtractor = { (item, index) => index.toString() }
             ...
             <TouchableHighlight style={[styles.buttonContainer, styles.signupButton]}  onPress={this.order}  >
              <Text style={styles.signUpText}>Place Order</Text>
            </TouchableHighlight>
