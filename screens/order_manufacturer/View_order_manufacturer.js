...
constructor(props)
  ...
  order = () => {
    ...
    return fetch('http://192.168.43.161/Ninelight/Manufacturer_order/Order_manufacturer.php',
    {
        method: 'POST',
      headers: {
  ...
  componentDidMount() {
    ...
    return fetch('http://192.168.43.161/Ninelight/Manufacturer_order/View_order_manufacturer.php',
    {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
...
FlatListItemSeparator = () => {
    ...
    <View style={styles.MainContainer}>
           ...
           Vertical={true}
            ...
            <Text style={styles.fonts}>{"\n"}{"\n"}quantity: {item.quantity}             Total Price:{item.total} </Text></Text>)}
